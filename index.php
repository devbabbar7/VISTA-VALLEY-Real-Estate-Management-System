      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-6 col-md-6">
            <p class="mb-0">
              <a href="#" class="mr-3"><span class="text-black fl-bigmug-line-phone351"></span> <span class="d-none d-md-inline-block ml-2">+91 123 456 7890</span></a>
              <a href="#"><span class="text-black fl-bigmug-line-email64"></span> <span class="d-none d-md-inline-block ml-2">dev.babbar@vistavalley.com</span></a>
            </p>  
          </div>
        ...
        <div class="container py-1">
          <div class="row align-items-center">
            <div class="col-8 col-md-8 col-lg-4">
              <h1 class=""><a href="index.php" class="h3 text-uppercase text-black"><strong>VISTA VALLEY<span class="text-danger"></span></strong></a></h1>
            </div>
          ...
          <div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
            <div class="feature d-flex align-items-start">
              ...
              <div class="text">
                ...
                <p>Discover a diverse array of properties at Vista Valley. From cozy homes to luxurious estates, we've got the perfect match for your real estate needs. Whether you're buying, selling, or exploring, our range ensures a tailored experience just for you.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
            <div class="feature d-flex align-items-start">
              ...
              <div class="text">
                ...
                <p>Vista Valley simplifies your property search, offering both rental and sales listings. Explore diverse options, from temporary rentals to permanent homeownership, all in one place. Make your real estate decisions effortlessly with us.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
            <div class="feature d-flex align-items-start">
              ...
              <div class="text">
                ...
                <p>Uncover the perfect property location with Vista Valley. Explore prime areas, neighborhoods, and regions that match your preferences and lifestyle. Your dream home's location is just a click away.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              <h3 class="footer-heading mb-4">About Vista Valley</h3>
              <p>Welcome to Vista Valley, founded by Dev Babbar. It is your ultimate online destination for all things real estate. We bring together buyers, sellers, and brokers in a seamless, efficient, and cost-effective forum. Discover the future of real estate interaction here.</p>
            </div>
