...
<html lang="en">
  <head>
    <title>VISTA VALLEY &mdash; Colorlib Website Template</title>
    <meta charset="utf-8">
        ...
        <div class="container py-1">
          <div class="row align-items-center">
            <div class="col-8 col-md-8 col-lg-4">
              <h1 class=""><a href="index.html" class="h3 text-uppercase text-black"><strong>VISTA VALLEY<span class="text-danger">.</span></strong></a></h1>
            </div>
